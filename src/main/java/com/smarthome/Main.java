...
public class Main {
    ...
    public static void main(String[] args) {
        SmartHome testHome = new SmartHome(10,25 , true);
        System.out.println("Initializing smart home...");
        testHome.addDevice(testHome.createDevice("Living Room Light", DeviceTypeEnum.DECORATIVE, DeviceGroupEnum.LIGHTS, DeviceLocationEnum.LIVINGROOM, true, 100, 0.15, 5000, 1));
        testHome.addDevice(testHome.createDevice("Bedroom Light", DeviceTypeEnum.ENTERTAINMENT, DeviceGroupEnum.LIGHTS, DeviceLocationEnum.BEDROOM, true, 100, 0.10, 4000, 1));
        ...
        testHome.addDevice(testHome.createDevice("Ceiling Fan (Living Room)", DeviceTypeEnum.HEALTH, DeviceGroupEnum.FANS, DeviceLocationEnum.LIVINGROOM, true, 100, 0.30, 10000, 1));
        testHome.addDevice(testHome.createDevice("Ceiling Fan (Bedroom)", DeviceTypeEnum.OFFICE, DeviceGroupEnum.FANS, DeviceLocationEnum.BEDROOM, true, 100, 0.25, 10000, 1));
        testHome.addDevice(testHome.createDevice("Desk Fan", DeviceTypeEnum.OTHERS, DeviceGroupEnum.FANS, DeviceLocationEnum.OFFICE, true, 100, 0.20, 5000, 1));
