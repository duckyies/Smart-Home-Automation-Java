...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        testHome.addDevice(testHome.createDevice("Chandelier", "Decorative", "Lights", "Living Room", true, 100, 0.50, 100, 100));
        testHome.addDevice(testHome.createDevice("Garden Light", "Decorative", "Lights", "Garden", true, 100, 0.20, 100, 100));
        ...
        testHome.addDevice(testHome.createDevice("Desk Fan", "Necessary", "Fans", "Office", true, 100, 0.20, 100, 100));
